...
<AssetObjects..TextureInstance>
	...
	<m_SourceFilePath text="F:\Mods\CIV\2019\RESOURCE\FATE_CHARLEMAGNE_SABER\LEADER_CHARLEMAGNE_SABER_BLUE_NEUTRAL.dds"/>
	<m_SourceObjectName text=""/>
	<m_ImportedTime>0</m_ImportedTime>
	<m_ExportedTime>2914344432</m_ExportedTime>
	<m_ClassName text="UserInterface"/>
	<m_DataFiles>
		<Element>
			<m_ID text="DDS"/>
			<m_RelativePath text="LEADER_CHARLEMAGNE_SABER_BLUE_NEUTRAL.dds"/>
		</Element>
	</m_DataFiles>
	<m_Name text="LEADER_CHARLEMAGNE_SABER_BLUE_NEUTRAL"/>
	<m_Description text=""/>
	<m_Tags>
