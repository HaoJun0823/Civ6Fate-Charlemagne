...
<AssetObjects..TextureInstance>
	...
	<m_SourceFilePath text="F:\Mods\CIV\2019\RESOURCE\FATE_CHARLEMAGNE_SABER\LEADER_CHARLEMAGNE_SABER_BACKGROUND_LOAD.dds"/>
	<m_SourceObjectName text=""/>
	<m_ImportedTime>0</m_ImportedTime>
	<m_ExportedTime>4003294772</m_ExportedTime>
	<m_ClassName text="UserInterface"/>
	<m_DataFiles>
		<Element>
			<m_ID text="DDS"/>
			<m_RelativePath text="LEADER_CHARLEMAGNE_SABER_BACKGROUND_LOAD.dds"/>
		</Element>
	</m_DataFiles>
	<m_Name text="LEADER_CHARLEMAGNE_SABER_BACKGROUND_LOAD"/>
	<m_Description text=""/>
	<m_Tags>
