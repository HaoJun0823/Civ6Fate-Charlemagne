...
<AssetObjects..TextureInstance>
	...
	<m_SourceFilePath text="F:\Mods\CIV\2019\RESOURCE\FATE_CHARLEMAGNE_SABER\LEADER_CHARLEMAGNE_SABER_BACKGROUND_FIRST.dds"/>
	<m_SourceObjectName text=""/>
	<m_ImportedTime>0</m_ImportedTime>
	<m_ExportedTime>2876775234</m_ExportedTime>
	<m_ClassName text="UserInterface"/>
	<m_DataFiles>
		<Element>
			<m_ID text="DDS"/>
			<m_RelativePath text="LEADER_CHARLEMAGNE_SABER_BACKGROUND_FIRST.dds"/>
		</Element>
	</m_DataFiles>
	<m_Name text="LEADER_CHARLEMAGNE_SABER_BACKGROUND_FIRST"/>
	<m_Description text=""/>
	<m_Tags>
